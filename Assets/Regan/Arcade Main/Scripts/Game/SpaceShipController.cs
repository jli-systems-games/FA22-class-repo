...
namespace Regan
{
    ...
    public class SpaceShipController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            ArcadeManager.instance.player = this;
        ...
        private void Shoot()
        {
            GameObject bullet = Instantiate(bulletPrefab, ArcadeManager.instance.worldTranform);
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            ArcadeManager.instance.PlayerDestroyed();
